...
CREATE TABLE `tb_blog` (
                           ...
                           `images` varchar(2048) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Store visit photos, up to 9, separated by commas',
                           `content` varchar(2048) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Text description of the visit',
                           `liked` int unsigned DEFAULT '0' COMMENT 'Number of likes',
                           `comments` int unsigned DEFAULT NULL COMMENT 'Number of comments',
                           `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation time',
                           `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Update time',
                           PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of tb_blog
-- ----------------------------
BEGIN;
INSERT INTO `tb_blog` VALUES (4, 4, 2, 'Endless Romantic Night丨Swaying Red Wine Glass🍷Among Flowers with Tomahawk Steak🥩', '/imgs/blogs/7/14/4771fefb-1a87-4252-816c-9f7ec41ffa4a.jpg,/imgs/blogs/4/10/2f07e3c9-ddce-482d-9ea7-c21450f8d7cd.jpg,/imgs/blogs/2/6/b0756279-65da-4f2d-b62a-33f74b06454a.jpg,/imgs/blogs/10/7/7e97f47d-eb49-4dc9-a583-95faa7aed287.jpg,/imgs/blogs/1/2/4a7b496b-2a08-4af7-aa95-df2c3bd0ef97.jpg,/imgs/blogs/14/3/52b290eb-8b5d-403b-8373-ba0bb856d18e.jpg', 'Life is half fireworks, half poetry.<br/>Hold fireworks to live, keep poetry to love.<br/>Of course,<br/>\r\nLearn to give yourself the romance your boyfriend cannot🍒<br/>\nA life that cannot be replayed, try to be happy.<br/><br/>🏰「Xiaozhuli · Mysterious Romantic Garden Restaurant」🏰<br/><br/>\n💯This is the most beautiful garden western restaurant, flowers everywhere: on tables, at the front desk. Beauty is everywhere.<br/>Taste a sip of wine, Via Merlot, slightly tipsy, fatigue disappears.<br/>Life is so beautiful🍃<br/><br/>📍Address: 200 Yan’an Road (in front of Carrefour)<br/><br/>🚌Transport: Subway Line 1, Ding’an Road Station Exit B, turn right, cross underpass, turn right to arrive.<br/><br/>--------------🥣Dish Details🥣---------------<br/><br/>"Tomahawk Steak"<br/>\nA huge tomahawk steak grilled with flame, fragrant and tender. Juices flow out when cut, the medium cooked steak is soft, tender beyond belief, can’t wait to taste it.<br/><br/>"Cream Bacon Pasta"<br/>So delicious💯<br/>Can’t describe its wonderful taste, creamy mushroom aroma mixed in pasta is amazing. I really licked the plate, not wasting a bit‼️<br/><br/><br/>"Cilantro Sauce Grilled Sea Bass"<br/>This sauce is spicy and delicious‼️<br/>The sea bass is tender and boneless, crispy skin after grilling, the fish dipped in sauce is addictive.<br/>Spicy lovers must try.<br/><br/>Very tasty 🍽\n<br/>--------------🍃Personal Feelings🍃---------------<br/><br/>【👩🏻‍🍳Service】<br/>The waitress patiently introduced lottery tickets, recommended signature dishes, helped with photos, very attentive, loved them.<br/><br/>【🍃Environment】<br/>A stylish western restaurant, layout like a flower-filled wonderland🌸<br/>Combining gourmet food, wine and flowers, so desirable.<br/>Life is fireworks, the world is romance.<br/>', 1, 104, '2021-12-28 19:50:01', '2022-03-10 14:26:34');
-- Other inserts remain unchanged for brevity
...
CREATE TABLE `tb_blog_comments` (
                                    `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
                                    `user_id` bigint unsigned NOT NULL COMMENT 'User ID',
                                    `blog_id` bigint unsigned NOT NULL COMMENT 'Blog post ID',
                                    `parent_id` bigint unsigned NOT NULL COMMENT 'Related top-level comment ID; 0 if top-level comment',
                                    ...
                                    `liked` int unsigned DEFAULT NULL COMMENT 'Number of likes',
...
CREATE TABLE `tb_follow` (
                             ...
                             `user_id` bigint unsigned NOT NULL COMMENT 'User ID',
                             `follow_user_id` bigint unsigned NOT NULL COMMENT 'Followed User ID',
                             `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation time',
                             PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_follow` VALUES (3, 1010, 1, '2025-06-05 16:05:49');
INSERT INTO `tb_follow` VALUES (6, 1, 2, '2025-06-05 16:29:55');
INSERT INTO `tb_follow` VALUES (7, 1, 1010, '2025-06-05 16:30:16');
INSERT INTO `tb_follow` VALUES (8, 1010, 2, '2025-06-05 16:31:40');
COMMIT;
...
CREATE TABLE `tb_seckill_voucher` (
                                      `voucher_id` bigint unsigned NOT NULL COMMENT 'Related coupon id',
                                      `stock` int NOT NULL COMMENT 'Stock quantity',
                                      `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation time',
                                      `begin_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Start time',
                                      `end_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Expiration time',
                                      `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Update time',
                                      PRIMARY KEY (`voucher_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT COMMENT='Flash sale coupons table, one-to-one relation with coupon';

-- ----------------------------
-- Records of tb_seckill_voucher
-- ----------------------------
BEGIN;
INSERT INTO `tb_seckill_voucher` VALUES (11, 99, '2025-05-16 22:56:34', '2025-05-14 22:56:34', '2025-05-31 22:56:34', '2025-05-23 12:59:53');
INSERT INTO `tb_seckill_voucher` VALUES (12, 100, '2025-05-28 22:25:43', '2025-05-28 22:25:43', '2025-05-28 22:25:43', '2025-05-28 22:25:43');
INSERT INTO `tb_seckill_voucher` VALUES (13, 99, '2025-05-28 22:31:44', '2025-05-28 22:31:44', '2025-05-28 22:31:44', '2025-06-01 12:19:05');
COMMIT;
...
CREATE TABLE `tb_shop` (
                           ...
                           `images` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Shop images, separated by commas',
                           `area` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Business district, e.g. Lujiazui',
                           ...
                           `avg_price` bigint unsigned DEFAULT NULL COMMENT 'Average price, integer',
                           ...
                           `score` int(2) unsigned zerofill NOT NULL COMMENT 'Rating, from 1 to 5, stored as times 10 to avoid decimals',
                           `open_hours` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Opening hours, e.g. 10:00-22:00',
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_shop` VALUES (1, '103 Tea Restaurant', 1, 'https://qcloud.dpfile.com/pc/jiclIsCKmOI2arxKN1Uf0Hx3PucIJH8q0QSz-Z8llzcN56-_QiKuOvyio1OOxsRtFoXqu0G3iT2T27qat3WhLVEuLYk00OmSS1IdNpm8K8sG4JN9RIm2mTKcbLtc2o2vfCF2ubeXzk49OsGrXt_KYDCngOyCwZK-s3fqawWswzk.jpg,https://qcloud.dpfile.com/pc/IOf6VX3qaBgFXFVgp75w-KKJmWZjFc8GXDU8g9bQC6YGCpAmG00QbfT4vCCBj7njuzFvxlbkWx5uwqY2qcjixFEuLYk00OmSS1IdNpm8K8sG4JN9RIm2mTKcbLtc2o2vmIU_8ZGOT1OjpJmLxG6urQ.jpg', 'Daguan', 'No.29 Jinchang Wenhua Garden, Jinhua Road', 120.149192, 30.316078, 80, 0000004215, 0000003035, 37, '10:00-22:00', '2021-12-22 18:10:39', '2025-05-16 17:31:47');
INSERT INTO `tb_shop` VALUES (2, 'Cai Ma Hongtao BBQ · Old Beijing Copper Pot Lamb', 1, 'https://p0.meituan.net/bbia/c1870d570e73accbc9fee90b48faca41195272.jpg,http://p0.meituan.net/mogu/397e40c28fc87715b3d5435710a9f88d706914.jpg,https://qcloud.dpfile.com/pc/MZTdRDqCZdbPDUO0Hk6lZENRKzpKRF7kavrkEI99OxqBZTzPfIxa5E33gBfGouhFuzFvxlbkWx5uwqY2qcjixFEuLYk00OmSS1IdNpm8K8sG4JN9RIm2mTKcbLtc2o2vmIU_8ZGOT1OjpJmLxG6urQ.jpg', 'Gongchenqiao / Shangtang', 'No.1035 Shangtang Road (next to ICBC)', 120.151505, 30.333422, 85, 0000002160, 0000001460, 46, '11:30-03:00', '2021-12-22 19:00:13', '2022-01-11 16:12:26');
INSERT INTO `tb_shop` VALUES (3, 'New Bailu Restaurant (Yunhe Shangjie Branch)', 1, 'https://p0.meituan.net/biztone/694233_1619500156517.jpeg,https://img.meituan.net/msmerchant/876ca8983f7395556eda9ceb064e6bc51840883.png,https://img.meituan.net/msmerchant/86a76ed53c28eff709a36099aefe28b51554088.png', 'Yunhe Shangjie', 'F5, Yunhe Shangjie Shopping Center, No.2 Taizhou Road', 120.151954, 30.32497, 61, 0000012035, 0000008045, 47, '10:30-21:00', '2021-12-22 19:10:05', '2022-01-11 16:12:42');
INSERT INTO `tb_shop` VALUES (4, 'Mamala (Hangzhou Yuanyang Ledi Port Branch)', 1, 'https://img.meituan.net/msmerchant/232f8fdf09050838bd33fb24e79f30f9606056.jpg,https://qcloud.dpfile.com/pc/rDe48Xe15nQOHCcEEkmKUp5wEKWbimt-HDeqYRWsYJseXNncvMiXbuED7x1tXqN4uzFvxlbkWx5uwqY2qcjixFEuLYk00OmSS1IdNpm8K8sG4JN9RIm2mTKcbLtc2o2vmIU_8ZGOT1OjpJmLxG6urQ.jpg', 'Gongchenqiao / Shangtang', 'No.66 Lishui Road, Yuanyang Ledi Port Mall Phase 2, 1F, B115', 120.146659, 30.312742, 290, 0000013519, 0000009529, 49, '11:00-22:00', '2021-12-22 19:17:15', '2022-01-11 16:12:51');
INSERT INTO `tb_shop` VALUES (5, 'Haidilao Hotpot (Shuijingcheng Shopping Center Branch)', 1, 'https://img.meituan.net/msmerchant/054b5de0ba0b50c18a620cc37482129a45739.jpg,https://img.meituan.net/msmerchant/59b7eff9b60908d52bd4aea9ff356e6d145920.jpg,https://qcloud.dpfile.com/pc/Qe2PTEuvtJ5skpUXKKoW9OQ20qc7nIpHYEqJGBStJx0mpoyeBPQOJE4vOdYZwm9AuzFvxlbkWx5uwqY2qcjixFEuLYk00OmSS1IdNpm8K8sG4JN9RIm2mTKcbLtc2o2vmIU_8ZGOT1OjpJmLxG6urQ.jpg', 'Daguan', 'No.458 Shangtang Road, Shuijingcheng Shopping Center F6', 120.15778, 30.310633, 104, 0000004125, 0000002764, 49, '10:00-07:00', '2021-12-22 19:20:58', '2022-01-11 16:13:01');
INSERT INTO `tb_shop` VALUES (6, 'Xingfuli Old Beijing Hotpot (Silian Branch)', 1, 'https://img.meituan.net/msmerchant/e71a2d0d693b3033c15522c43e03f09198239.jpg,https://img.meituan.net/msmerchant/9f8a966d60ffba00daf35458522273ca658239.jpg,https://img.meituan.net/msmerchant/ef9ca5ef6c05d381946fe4a9aa7d9808554502.jpg', 'Gongchenqiao / Shangtang', 'No.189 Jinhua South Road, Silian 166', 120.148603, 30.318618, 130, 0000009531, 0000007324, 46, '11:00-13:50,17:00-20:50', '2021-12-22 19:24:53', '2022-01-11 16:13:09');
INSERT INTO `tb_shop` VALUES (7, 'Luyu (Gongshu Wanda Plaza Branch)', 1, 'https://img.meituan.net/msmerchant/909434939a49b36f340523232924402166854.jpg,https://img.meituan.net/msmerchant/32fd2425f12e27db0160e837461c10303700032.jpg,https://img.meituan.net/msmerchant/f7022258ccb8dabef62a0514d3129562871160.jpg', 'North New City', 'No.666 Hangxing Road, Wanda Commercial Center Building 4, Unit 2, Room 409 (Shop No. 4005)', 120.124691, 30.336819, 85, 0000002631, 0000001320, 47, '00:00-24:00', '2021-12-22 19:40:52', '2022-01-11 16:13:19');
INSERT INTO `tb_shop` VALUES (8, 'Asakusa Sushi (Yunhe Shangjie Branch)', 1, 'https://img.meituan.net/msmerchant/cf3dff697bf7f6e11f4b79c4e7d989e4591290.jpg,https://img.meituan.net/msmerchant/0b463f545355c8d8f021eb2987dcd0c8567811.jpg,https://img.meituan.net/msmerchant/c3c2516939efaf36c4ccc64b0e629fad587907.jpg', 'Yunhe Shangjie', 'No.80 Jinhua Road, Yunhe Shangjie, Gongshu District B1', 120.150526, 30.325231, 88, 0000002406, 0000001206, 46, '11:00-21:30', '2021-12-22 19:51:06', '2022-01-11 16:13:25');
INSERT INTO `tb_shop` VALUES (9, 'Yang Lao San Lamb Spine & Beef Rib North Style Charcoal Hotpot (Yunhe Shangjie Branch)', 1, 'https://p0.meituan.net/biztone/163160492_1624251899456.jpeg,https://img.meituan.net/msmerchant/e478eb16f7e31a7f8b29b5e3bab6de205500837.jpg,https://img.meituan.net/msmerchant/6173eb1d18b9d70ace7fdb3f2dd939662884857.jpg', 'Yunhe Shangjie', 'F5, Yunhe Shangjie Shopping Center, No.2 Taizhou Road', 120.150598, 30.325251, 101, 0000002763, 0000001363, 44, '11:00-21:30', '2021-12-22 19:53:59', '2022-01-11 16:13:34');
INSERT INTO `tb_shop` VALUES (10, 'Kailadi KTV (Yunhe Shangjie Branch)', 2, 'https://p0.meituan.net/joymerchant/a575fd4adb0b9099c5c410058148b307-674435191.jpg,https://p0.meituan.net/merchantpic/68f11bf850e25e437c5f67decfd694ab2541634.jpg,https://p0.meituan.net/dpdeal/cb3a12225860ba2875e4ea26c6d14fcc197016.jpg', 'Yunhe Shangjie', 'F4, Yunhe Shangjie Shopping Center, No.2 Taizhou Road', 120.149093, 30.324666, 67, 0000026891, 0000000902, 37, '00:00-24:00', '2021-12-22 20:25:16', '2021-12-22 20:25:16');
INSERT INTO `tb_shop` VALUES
    (11, 'INLOVE KTV (Crystal City Branch)', 2,
     ...
     'Crystal City', '6th Floor, No. 458 Shangtang Road, Crystal City Shopping Center', 120.15853, 30.310002, 75, 0000035977, 0000005684, 47, '11:30-06:00', '2021-12-22 20:29:02', '2021-12-22 20:39:00');

INSERT INTO `tb_shop` VALUES
    (12, 'Charm (Hangzhou Yuanyang Ledigang Branch)', 2,
     ...
     'Yuanyang Ledigang', '4th Floor, No. 58 Lishui Road, Yuanyang Ledigang', 120.14983, 30.31211, 88, 0000006444, 0000000235, 46, '10:00-02:00', '2021-12-22 20:34:34', '2021-12-22 20:34:34');

INSERT INTO `tb_shop` VALUES
    (13, 'OuK La Self-service KTV (Beicheng Tiandi Branch)', 2,
     ...
     'D32 Tianyang Shopping Center', '5th Floor, No. 567 Huzhou Street, Beicheng Tiandi', 120.130453, 30.327655, 58, 0000018997, 0000001857, 41, '12:00-02:00', '2021-12-22 20:38:54', '2021-12-22 20:40:04');

INSERT INTO `tb_shop` VALUES
    (14, 'Star Club KTV (Gongshu Wanda Branch)', 2,
     ...
     'North New City', '1-2F, Block C, Wanda Plaza, No. 666 Hangxing Road', 120.128958, 30.337252, 60, 0000017771, 0000000685, 47, '10:00-22:00', '2021-12-22 20:48:54', '2021-12-22 20:48:54');
COMMIT;
...
CREATE TABLE `tb_shop_type` (
                                ...
                                `sort` int unsigned DEFAULT NULL COMMENT 'Order',
                                `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation time',
                                `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Update time',
                                PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_shop_type` VALUES (1, 'Food', '/types/ms.png', 1, '2021-12-22 20:17:47', '2021-12-23 11:24:31');
INSERT INTO `tb_shop_type` VALUES (2, 'KTV', '/types/KTV.png', 2, '2021-12-22 20:18:27', '2021-12-23 11:24:31');
INSERT INTO `tb_shop_type` VALUES (3, 'Beauty & Hair', '/types/lrmf.png', 3, '2021-12-22 20:18:48', '2021-12-23 11:24:31');
INSERT INTO `tb_shop_type` VALUES (4, 'Fitness & Sports', '/types/jsyd.png', 10, '2021-12-22 20:19:04', '2021-12-23 11:24:31');
INSERT INTO `tb_shop_type` VALUES (5, 'Massage & Foot Therapy', '/types/amzl.png', 5, '2021-12-22 20:19:27', '2021-12-23 11:24:31');
INSERT INTO `tb_shop_type` VALUES (6, 'Beauty SPA', '/types/spa.png', 6, '2021-12-22 20:19:35', '2021-12-23 11:24:31');
INSERT INTO `tb_shop_type` VALUES (7, 'Parent-Child Entertainment', '/types/qzyl.png', 7, '2021-12-22 20:19:53', '2021-12-23 11:24:31');
INSERT INTO `tb_shop_type` VALUES (8, 'Bar', '/types/jiuba.png', 8, '2021-12-22 20:20:02', '2021-12-23 11:24:31');
INSERT INTO `tb_shop_type` VALUES (9, 'Party Venue', '/types/hpg.png', 9, '2021-12-22 20:20:08', '2021-12-23 11:24:31');
INSERT INTO `tb_shop_type` VALUES (10, 'Eyelash & Nail', '/types/mjmj.png', 4, '2021-12-22 20:21:46', '2021-12-23 11:24:31');
COMMIT;
...
CREATE TABLE `tb_sign` (
                           ...
                           `is_backup` tinyint unsigned DEFAULT NULL COMMENT 'Is Makeup Sign-in',
                           PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPACT;
...
CREATE TABLE `tb_user` (
                           ...
                           `password` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT 'Password (encrypted)',
                           `nick_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT 'Nickname (default is user ID)',
                           `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT 'User avatar',
                           `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation time',
                           `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Update time',
                           PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_user` VALUES (1, '13686869696', '', 'LittleFish', '/imgs/blogs/blog1.jpg', '2021-12-24 10:27:19', '2022-01-11 16:04:00');
INSERT INTO `tb_user` VALUES (2, '13838411438', '', 'CocoNoMeatToday', '/imgs/icons/kkjtbcr.jpg', '2021-12-24 15:14:39', '2021-12-28 19:58:04');
INSERT INTO `tb_user` VALUES (4, '13456789011', '', 'user_slxaxy2au9f3tanffaxr', '', '2022-01-07 12:07:53', '2022-01-07 12:07:53');
INSERT INTO `tb_user` VALUES (5, '13456789001', '', 'Cutie', '/imgs/icons/user5-icon.png', '2022-01-07 16:11:33', '2022-03-11 09:09:20');
...
INSERT INTO `tb_user` VALUES (1010, '15905903059', '', 'user_j52hbt9n5l', '', '2025-05-07 17:52:18', '2025-05-07 17:52:18');
COMMIT;
...
CREATE TABLE `tb_user_info` (
                                ...
                                `introduce` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Personal introduction, no more than 128 characters',
                                `fans` int unsigned DEFAULT '0' COMMENT 'Number of fans',
                                `followee` int unsigned DEFAULT '0' COMMENT 'Number of people followed',
                                `gender` tinyint unsigned DEFAULT '0' COMMENT 'Gender, 0: Male, 1: Female',
                                `birthday` date DEFAULT NULL COMMENT 'Birthday',
                                `credits` int unsigned DEFAULT '0' COMMENT 'Credits',
                                `level` tinyint unsigned DEFAULT '0' COMMENT 'Membership level, 0~9, 0 means not a member',
                                `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation time',
                                `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Update time',
...
CREATE TABLE `tb_voucher` (
                              ...
                              `pay_value` bigint unsigned NOT NULL COMMENT 'Payment amount in cents (e.g. 200 = 2.00 AUD)',
                              `actual_value` bigint NOT NULL COMMENT 'Discount amount in cents (e.g. 200 = 2.00 AUD)',
                              `type` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '0: Regular voucher; 1: Flash sale voucher',
                              `status` tinyint unsigned NOT NULL DEFAULT '1' COMMENT '1: Active; 2: Inactive; 3: Expired',
                              `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation time',
                              `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Update time',
                              PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_voucher` VALUES (1, 1, '50 AUD Voucher', 'Valid Monday to Sunday', 'Valid site-wide\nNo reservation needed\nStackable\nNo cash redemption or change\nDine-in only', 4750, 5000, 0, 1, '2022-01-04 09:42:39', '2022-01-04 09:43:31');
INSERT INTO `tb_voucher` VALUES (2, 1, '80 AUD Voucher', 'Valid Monday to Sunday', 'Valid site-wide\nNo reservation needed\nStackable\nNo cash redemption or change\nDine-in only', 4750, 5000, 0, 1, '2022-01-04 09:42:39', '2025-05-16 23:05:49');
INSERT INTO `tb_voucher` VALUES (11, 1, '100 AUD Voucher', 'Valid Monday to Friday', 'Valid site-wide\nNo reservation needed\nStackable\nNo cash redemption or change\nDine-in only', 8000, 10000, 1, 1, '2025-05-16 22:56:34', '2025-05-16 23:09:47');
INSERT INTO `tb_voucher` VALUES (12, 1, '200 AUD Voucher', 'Valid Monday to Friday', 'Valid site-wide\nNo reservation needed\nStackable\nNo cash redemption or change\nDine-in only', 8000, 10000, 1, 1, '2025-05-28 22:25:43', '2025-05-28 22:25:43');
INSERT INTO `tb_voucher` VALUES (13, 1, '300 AUD Voucher', 'Valid Monday to Friday', 'Valid site-wide\nNo reservation needed\nStackable\nNo cash redemption or change\nDine-in only', 8000, 10000, 1, 1, '2025-05-28 22:31:44', '2025-05-28 22:31:44');
COMMIT;
...
CREATE TABLE `tb_voucher_order` (
                                    ...
                                    `user_id` bigint unsigned NOT NULL COMMENT 'User ID who placed the order',
                                    ...
                                    `status` tinyint unsigned NOT NULL DEFAULT '1' COMMENT 'Order status: 1=Unpaid; 2=Paid; 3=Redeemed; 4=Cancelled; 5=Refunding; 6=Refunded',
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_voucher_order` VALUES (462933668474650625, 1010, 13, 1, 1, '2025-06-01 12:19:05', NULL, NULL, NULL, '2025-06-01 12:19:05');
COMMIT;
